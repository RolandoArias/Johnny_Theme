...
<div class="tp-banner-container" style="height:400px;overflow: hidden">
<div class="tp-banner pi-revolution-slider-home" >
<ul class="">	
	<!-- SLIDE -->
	<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" >
		...
		<div class="tp-caption sft str"
			 ...
			 data-endspeed="300"
			 style="z-index: 5; font-size: 34px; color: white; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; line-height: 40px;  padding: 12px 16px; ">
			 ¿Sorprendido?
		</div>

		<!-- LAYER NR. 4 -->
		<div class="tp-caption sfl str"
			 data-x="725" data-hoffset="0"
			 data-y="330"
			 data-speed="500"
			 data-start="2600"
			 data-easing="Back.easeInOut"
...
<div class="pi-row pi-section-menu pi-no-padding pi-no-margin">
	<div class="pi-col-md-12 background-blue height-100 ">
		...
		<div class="pi-col-md-2 pi-text-center pi-padding-10"><a href="solicitud-tarifa.php">Solicitud de Tarifas</a></div>
	</div>
</div>